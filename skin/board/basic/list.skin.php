...
<div id="bo_list" style="width:<?php echo $width; ?>">
   ...
   <div class="board-serach-frm">
       ...
       <div class="search-top-wrap aside-top-pos">
           ...
           <a href="<?php echo $write_href ?>" class="write-btn btn"><i class="fas fa-pen"></i></a>
           <?php endif ?>
       </div>
            ...
            <div class="list-wrap <?php echo $notice ?>">
                ...
                <div class="list-img-warp">
                    <?php if ($img_src != ""): ?>
                        ...
                        <img src="<?php echo G5_URL ?>/data/file/<?php echo $_GET['bo_table'] ?>/<?php echo $img_src ?>" alt="<?php echo $img_src ?>" class="list-img">
                        </a>
                    <?php endif ?>
                </div>
...
<script>
    ...
    $(function(){
        var name = ".<?php echo $_GET['sst'] ? $_GET['sst'] : 'wr_hit' ?>";
