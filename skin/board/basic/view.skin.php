...
<article id="bo_v" class="aside-top-pos" style="width:<?php echo $width; ?>">
    <header>
        <h2 id="bo_v_title">
 ...
 <!--    <div id="bo_v_share">
    ...
    ?>
    <?php while ($list = sql_fetch_array($lists)) { ?>
        <div class="v-bottom-list" style="justify-content: initial;">
            <div class="v-wrgood">
                <img src="<?php echo G5_IMG_URL ?>/icon-vote-up.png" alt="icon-vote-up"> <?php echo $list['wr_good']; ?></div>
            <div class="v-subject"><a href="<?php echo G5_BBS_URL."/board.php?bo_table={$_GET['bo_table']}&wr_id={$list['wr_id']}" ?>"><?php echo $list['wr_subject']; ?></a></div>
            <div class="v-datetime">
                <?php echo passingTime($list['wr_datetime']); ?>            
            </div>
            <div class="v-writer"> <?php echo $list['wr_name']; ?></div>
        </div>
    <?php } ?>
</article>
<!-- } 게시판 읽기 끝 -->
